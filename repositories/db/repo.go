...
func NewEventRepositoryImpl(client *gorm.DB) *EventRepositoryImpl {
...
func (repo *EventRepositoryImpl) ListEvents() ([]*models.Event, error) {
...
func (repo *EventRepositoryImpl) ReadEventByID(id int) (*models.Event, error) {
